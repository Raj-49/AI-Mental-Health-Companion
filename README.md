# **AI Mental Health Companion - Project Documentation (Sections 0 to 3)**
# **Project Overview**
...
# **AI Mental Health Companion – System Workflow**
...
\- Resolved missing DATABASE\_URL variable in deployment.\
...
## **📘 Prisma Data Model Documentation – AI Mental Health Companion**
...
|**fullName**|String?|Optional, mapped as full\_name|
|**email**|String|@unique|
...
|**energyLevel**|Int|Mapped as energy\_level|
|**stressLevel**|Int|Mapped as stress\_level|
